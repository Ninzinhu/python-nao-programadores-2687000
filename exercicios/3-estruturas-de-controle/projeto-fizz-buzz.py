...
lista_numerica = list(range(15,31)) #Objeto do tipo interavel
indice = 0 #O primeiro indice da linguagem python

for numero in lista_numerica:
  if numero % 3 == 0 and numero % 5 == 0 :
    lista_numerica[indice] = 'FizzBuzz'
  elif numero % 3 == 0: #Se o número for divisível por 3, o valor do elemento correspondente na lista é substituído por 'Fizz'
